...
few of these have the capability of efficiently detecting duplicated code in a real-time
IDE environment.

This thesis will present a tool and technique for language and IDE agnostic clone
detection, which runs in an IDE environment. Special focus is put on incremental
detection, since code clone detection can be expensive to perform, even if most clone
detection results persist while editing source code.
...
% TODO Write about incremental parsing algorithms here
