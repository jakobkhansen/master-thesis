...
with it with the same time complexity. The advantage of using a suffix array is that it
uses a smaller amount of memory~\cite{ReplaceSuffixTreeWithEnchancedSuffixArray}. The
extended suffix array is the major data structure which will be used in our detection
algorithm to find duplicate code, as explained in the upcoming implementation chapters.
