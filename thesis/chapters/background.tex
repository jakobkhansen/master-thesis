...
to the index where the suffix starts in T. Conversely, the inverse suffix array (\texttt{ISA})
contains integers describing which rank a suffix has. \texttt{ISA[i] = n} describes that the suffix
...
Table \ref{table:BANANA} shows the suffix array of a text $T=\text{BANANA\$}$ and the correlation
