...
detection algorithm~\cite{LinearTimeSuffixArraySAIS}. 

The extended (enhanced) suffix array is the suffix array and the additional LCP array,
...
uses a smaller amount of memory~\cite{ReplaceSuffixTreeWithEnchancedSuffixArray}.
