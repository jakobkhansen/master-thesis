...
cases of potential LCP updates, where we need to iterate over suffixes did not lead to any
additional changes in this instance.
...
translation of Algorithm \ref{alg:buildclonemap}, to $2$ traversals needed with the
smarter traversal of nodes described here.
