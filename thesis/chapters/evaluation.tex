...
To create a larger sample set of code bases and edits, it is preferrable to generate new
...
have been averaged. Only three runs of all tests were performed because running all the
tests takes a significant amount of time (multiple hours), and the results seems to be
very stable from these three runs only.
