...
The next step is to feed the fingerprint into a suffix array construction algorithm
(SACA). All the fingerprints which are stored in each document object is concatenated to
be stored in a single integer array
